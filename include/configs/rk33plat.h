...
#if 1 /* experiment with GPT Harddisk*/
#define TSAI_UMS_BOOT_GPT /* ignore original RK UMS boot and use my own UMS GPT boot */
#define CONFIG_CMD_GPT /* TSAI: to have GPT*/
#define CONFIG_PARTITION_UUIDS
#define CONFIG_EFI_PARTITION
#define HAVE_BLOCK_DEVICE
#define CONFIG_CMD_PART /* command 'part' */
#endif
...
#define CONFIG_RK_UMS_BOOT_EN /* TSAI: experiment, I need USB mass storage to use SATA hard drive */
...
#define RKUSB_UMS_BOOT_FROM_EHCI_HOST1
...
/*TSAI*/
/* Geekbox SATA is actually USB mass storage*/
#define CONFIG_CMD_USB
...
/*in runtime, this message should mean this is not CONFIG_SATA_ULI5288
SCSI:  Error: SCSI Controller(s) 10B9:5288 not Found
*/
#endif
#if 0
/* if going with AHCI, it can build u-boot.img,
CONFIG_PCI=y is needed, to have scsi_init()
 */
...
#if 0 /* too many link problems, give up */
